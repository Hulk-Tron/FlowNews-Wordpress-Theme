...
function eltdInitVideoBackground(){
	...
	*/
    ...
    function eltdInitSelfHostedVideoPlayer() {
        ...
        if(!players.hasClass('eltd-video-played')) {
            players.addClass('eltd-video-played');
...
(function($) {
    ...
    header.eltdSetNavigationMenuStyles = eltdSetNavigationMenuStyles;
    ...
    */
    ...
    function eltdSetNavigationMenuStyles(){

        var menuItems = $('.eltd-main-menu>ul>li');
        menuItems.on('click', function() {
            var thisMenuItem = $(this);
            menuItems.removeClass('eltd-active-item');
            thisMenuItem.addClass('eltd-active-item');
        })
